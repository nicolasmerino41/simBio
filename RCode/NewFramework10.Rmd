...
\[
\frac{1}{B_i}\frac{dB_i}{dt} \;=\; d_i\,\Biggl[ -\frac{m_i}{d_i} - B_i + \sum_{j \in \text{preys of } i} \frac{d_j\,\varepsilon\,a_{ij}\,B_j}{d_j} - \sum_{j \in \text{predators of } i} \frac{a_{ji}\,B_j}{d_j}\Biggr],
\]
...
\]
\[
\xi_i = \frac{m_i}{d_i} \quad \text{(Mortality Threshold)},
\]
\[
