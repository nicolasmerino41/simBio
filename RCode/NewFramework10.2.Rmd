...
This theoretical framework sets the stage for comparing analytical predictions (via \(J\) and \(V\)) with simulation‐based metrics across our ladder of model simplifications.
...
- On average, prey‐gains contribute \(\varepsilon\,k_i^{\mathrm{out}}\), predator‐losses contribute \(k_i^{\mathrm{in}}\), so define the net interaction strength  
  ...
  $$
- Thus the off‑diagona row‑sum in the bracket is approximately \(S_i\), and the self‑term becomes  
  $$
