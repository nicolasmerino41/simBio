...
\(M_{ij} = \mu_{ij} + \dfrac{C_{ij} H_i^0}{m_i}\), where \(\mu_{ij}\) represents the baseline interaction (competition) between herbivore species \(i\) and \(j\), and \(\dfrac{C_{ij} H_i^0}{m_i}\) arises from predator effects. Specifically, predation is incorporated by defining
$$
