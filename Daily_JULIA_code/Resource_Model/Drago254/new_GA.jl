...
function fitness(params, local_i, local_j, sp_nm, localNPP, localH0_vector)
    ...
    params = (S2, R2, H_i0, m_i, g_i, beta, G, M_modified, a_matrix, A, epsilon, m_alpha)
...
open("Results/new_GA/new_ga_results.csv", "w") do io
    CSV.write(io, df_header; header=true)
end
