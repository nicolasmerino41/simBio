...
for cell in 1:7
    ...
    for p_idx in 1:length(param_combinations)
        ...
        herbivore_survival_rate = round(survived_herb / S, digits = 2)
        predator_survival_rate = round(survived_pred / R, digits = 2)
        ...
        herb_pred_ratio = round(P_biomass/H_biomass, digits = 5)
