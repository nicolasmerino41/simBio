function new_attempt_setup_community(
    ...
    try
        ...
        # If successful, return a NamedTuple with all the computed parameters.
        return (
            S = S2, 
            R = R2,
            species_names = species_names,
        ...
        # Optionally log the error and return nothing.
        # @warn "Failed in attempt_setup_community: $e\n$(catch_backtrace())"
        return nothing
    end
end
