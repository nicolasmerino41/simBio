function abstract_run(
    ...
    params = (S_total, R, K_i, r_i, mu_val, nu_val, P_matrix, O_matrix, T_matrix, epsilon, m_alpha, K_alpha, B_matrix, D_matrix, nu_val*nu_omni_proportion, nu_val*nu_b_proportion)
    ...
    if perturbation_halfway
        if species_to_perturb > 0 && species_to_perturb <= S_total+R
            ...
            prob2 = ODEProblem(omnivore_dynamics!, u0_perturbed, (time_end, time_end+time_end), params)
            if use_cb
