...
ENV["RASTERDATASOURCES_PATH"] = "C:\\Users\\MM-1\\OneDrive\\PhD\\JuliaSimulation\\simBio"

raster = getraster(CHELSA{BioClim}, 2)
...
dates = collect(Date(2023,1):Month(1):Date(2023, 8))
